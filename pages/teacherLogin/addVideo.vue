  ...
  <el-row>
    <el-col :span="24">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item :to="{ path: '/teacherLogin/curriculum' }">课程管理<span>《{{curriculumName}}》</span></el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/teacherLogin/curriculum-chapter' }">章节<span>《{{chapterName}}》</span></el-breadcrumb-item>
        <el-breadcrumb-item v-if="knowledgeName!='未选择小结'" :to="{path:'/teacherLogin/curriculum-chapter/summary'}">小结<span>《{{knowledgeName}}》</span></el-breadcrumb-item>
      </el-breadcrumb>
      <br>
  ...
  export default {
    ...
    methods:{
      ...
      newVideo:function (res) {
        ...
        this.$router.push("/teacherLogin/curriculum-chapter/summary")
      }
    },
    resetForm(formName) {
