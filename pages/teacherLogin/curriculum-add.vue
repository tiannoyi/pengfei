  ...
  <div class="container">
    <div class="right">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item :to="{ path: '/teacherLogin/curriculum' }">课程管理</el-breadcrumb-item>
        ...
        <div class="type-form" >
          <el-form :model="ruleForm"  ref="ruleForm" label-width="150px" label-position="right" class="demo-ruleForm">
            ...
            <el-form-item label="课程类别名：" @click="selectUniversity">
              ...
              <el-button type="text"  size="small"  @click="selectCT">点击选则课程类别</el-button>
            </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      handleSizeChangeCT:function (sizeChange) {
        this.sizeCT=sizeChange;
        this.refreshCT(1,this.sizeCT);
      },
      //当前页数改变
      handleCurrentChange:function (current) {
        this.refreshUniversity(current,this.size);
      },
      handleCurrentChangeCT:function (current) {
        this.refreshCT(current,this.sizeCT);
      },
      ...
      successVideo:function () {
       this.dialogVideo=false;
        ...
        this.$router.push('/teacherLogin/curriculum');
      }
    },
    mounted:function(){
