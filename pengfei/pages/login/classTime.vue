    ...
    >
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.status">开课中</el-tag>
          <el-tag type="warning" v-if="!scope.row.status">已过期</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        prop="schedules"
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible">
      <el-form :model="tution" :rules="rules" ref="tution" label-width="100px" class="demo-ruleForm">
        <el-form-item label="开课人数：">
          <el-input v-model="tution.population"></el-input>
        </el-form-item>
